...
import './Caloriecalc.css'; // pastikan file CSS ini ada di folder yang sama
...
function CalorieForm() {
  ...
  const handleSubmit = (e) => {
    ...
    // Kalkulasi logika bisa kamu tambahkan di sini nanti
    console.log('Form submitted:', form);
    navigate('/calorie-result'); // arahkan ke halaman hasil
  };
